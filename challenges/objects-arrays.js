...
console.log(`Once you have the new array created, sort the universities alphabetically and log the result.`);

const universities = [];
graduates.forEach(g => universities.push(g.university));
...
const contactInfo = [];
graduates.forEach(g => contactInfo.push(`${g.first_name} ${g.email}`));
...
console.log(`Given this zoo data from around the United States, follow the instructions below.
...
const populationTotal = zooAnimals.reduce((total, t) => total += t.population, 0);
